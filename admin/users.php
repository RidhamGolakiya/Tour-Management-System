  ...
  <div class="body-wrapper">
    ...
    <div class="p-5">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <h3>Users</h3>
        <a class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#userModal" href="#">Create User</a>
      </div>
    </div>
  ...
  $(document).ready(function() {
    $('#dataTable').DataTable({
      ...
      "columns": [{
        ...
        {
          "render": function(data, type, full, meta) {
            return '<button name="view" title="View User" value="view" id="' + full.user_id + '" class="btn btn-warning mx-1 view_data"><span class="fa fa-eye"></span></button>' +
              '<button name="edit" title="Edit User" value="Edit" id="' + full.user_id + '" class="btn btn-info mx-1 edit_data"><span class="fa fa-pencil"></span></button>' +
              '<button value=' + full.user_id + ' class="userDelete btn btn-danger mx-1" title="Delete User" name="deletedata" data-toggle="tooltip"><span class="fa fa-trash"></span></button>';
          },
          "orderable": false
        }
      ],
