...
try {
    if (isset($_SESSION['user_id'])) {
        ...
        $user = "SELECT * FROM users where user_id =$userID and role = 2";
...
if (isset($_POST['btnProfile'])) {
    ...
    $updatedProfile = "UPDATE users SET username='$updatedUsername', phone_no='$updatedPhone_no', image='$imageName' WHERE user_id=$userID";
    $updateUser = mysqli_query($con, $updatedProfile);
    if ($updateUser) {
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label class="mb-2"><b>Username: </b></label><span class="text-danger">*</span>
                                    ...
                                    <div class="d-flex mt-5">
                                        <div><button class="btn btn-outline-secondary me-3" name="btnProfile">Save</button></div><a class="btn btn-secondary me-3" href="<?php echo $appUrl;?>/manager/dashboard.php">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
